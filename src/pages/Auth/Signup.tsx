...
const Signup: React.FC = () => {
  ...
  const { signupWithEmail, signupWithSocial, error, isLoading, clearError } = useAuth();
  ...
  const onSubmit = async (data: SignupFormData) => {
    try {
      await signupWithEmail(data.email, data.username, data.password);
      navigate('/');
    } catch (err) {
  ...
  return (
    <>
      <Seo
        title="Sign Up for SketchyAF"
        description="Create your SketchyAF account to join the drawing mayhem and compete with other players."
      />
      ...
      <section className="min-h-screen py-20 bg-cream flex items-center justify-center">
        ...
        >
          <div className="mb-6 flex justify-between items-center">
            ...
            <h2 className="font-heading font-bold text-2xl md:text-3xl text-dark">Create Account</h2>
              ...
              <motion.div variants={itemVariants}>
                <div className="relative">
                  <Input
                    ...
                    label="Username"
                    type="text"
                    placeholder="AwesomeSketchArtist"
                  ...
                  />
                  <User className="absolute right-3 bottom-3 text-medium-gray" size={20} />
                </div>
              </motion.div>
